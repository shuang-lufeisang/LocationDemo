...
import com.duan.location.providers.locationprovider.DispatcherLocationProvider;
import com.duan.location.providers.locationprovider.LocationProvider;
import com.duan.location.providers.permissionprovider.PermissionProvider;
...
public class LocationManager implements PermissionListener {
    ...
    void askForPermission() {
        if (permissionProvider.hasPermission()) {
            LogUtils.logE(" ===== askForPermission ===== permissionProvider.hasPermission() ");
    ...
    private void permissionGranted(boolean alreadyHadPermission) {
        ...
        activeProvider.get();  // permissionGranted
    }
