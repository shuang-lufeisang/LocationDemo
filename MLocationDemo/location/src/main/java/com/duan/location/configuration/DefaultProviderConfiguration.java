...
import com.duan.location.constants.ProviderType;
import com.duan.location.providers.dialogprovider.DialogProvider;
import com.duan.location.providers.dialogprovider.SimpleMessageDialogProvider;
import com.duan.location.utils.StringUtils;

public class DefaultProviderConfiguration {

    private final long requiredTimeInterval;       // 时间间隔
    private final long requiredDistanceInterval;   // 地理位置间隔
    private final float acceptableAccuracy;        // 精度
    ...
    // DefaultProviderConfigurationTest 使用
    ...
    public static class Builder {
        ...
        private long requiredTimeInterval = Defaults.LOCATION_TIME_INTERVAL;
         ...
         * Default is {@linkplain Defaults#LOCATION_TIME_INTERVAL}
         */
